...
4. Create a schedule-history.csv file following the template provided in the sample data folder for the applicable version of REACH. Store in 'Input Files'.
5. Run the Python processing script using the files in 'Input Files'. The output will automatically populate in 'Output Files'.
6. Run the R cleaning script using the 'flow_final.csv' file from 'Output Files', making updates as needed.
